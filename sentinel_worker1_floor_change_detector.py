...
# Corrected X,Y rectangle logic for Dig Stage ROI
HUD_BOX_X1, HUD_BOX_Y1 = 185, 330
HUD_BOX_X2, HUD_BOX_Y2 = 285, 350
...
def run_precision_sentinel():
    ...
    print(f"\n\n--- PASS 1 PERFORMANCE ---")
    print(f" Frames: {total_frames} | Speed: {total_frames / elapsed:.2f} FPS")
