...
# Version: 1.7 (The Dynamic Anchor Wall: Resolving Over-Scans)
...
def run_boundary_verification():
    ...
    print(f"--- STEP 3: BOUNDARY VERIFICATION v1.7 ---")
    
    final_boundaries = []
    integrity_logs = []
    
    # Pre-calculate the end of previous floor blocks to set hard walls
    ...
    for i, row in df.iterrows():
        ...
        if i > 0:
            ...
            if target_dna == prev_dna:
                ...
                # DYNAMIC ANCHOR WALL:
                # We find the end of the previous floor's actual mining block from Step 2.
                # A floor transition CANNOT happen before the previous floor stopped mining.
        ...
        if i > 0:
            # Seal the previous floor's timeline exactly
    ...
    for f in final_boundaries:
        ...
        # Proof images are generated for monitored floors or legitimate corrections
